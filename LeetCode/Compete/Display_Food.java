 ...
 * "3","Fried Chicken"],["Carla","5","Water"],["Carla","5","Ceviche"],["Rous",
 * "3","Ceviche"]] Output:
 * [["Table","Beef Burrito","Ceviche","Fried Chicken","Water"],["3","0","2","1",
 * "0"],["5","0","1","0","1"],["10","1","0","0","0"]] Explanation: The
 * displaying table looks like: Table,Beef Burrito,Ceviche,Fried Chicken,Water 3
 * ,0 ,2 ,1 ,0 5 ,0 ,1 ,0 ,1 10 ,1 ,0 ,0 ,0 For the table 3: David orders
 * "Ceviche" and "Fried Chicken", and Rous orders "Ceviche". For the table 5:
 * Carla orders "Water" and "Ceviche". For the table 10: Corina orders
 * "Beef Burrito".
 * 
 * Example 2:
 * 
 * Input: orders =
 * [["James","12","Fried Chicken"],["Ratesh","12","Fried Chicken"],["Amadeus",
 * "12","Fried Chicken"],["Adam","1","Canadian Waffles"],["Brianna",
 * "1","Canadian Waffles"]] Output:
 * [["Table","Canadian Waffles","Fried Chicken"],["1","2","0"],["12","0","3"]]
 * Explanation: For the table 1: Adam and Brianna order "Canadian Waffles". For
 * the table 12: James, Ratesh and Amadeus order "Fried Chicken".
 * 
 * Example 3:
 * 
 * Input: orders =
 * [["Laura","2","Bean Burrito"],["Jhon","2","Beef Burrito"],["Melissa","2",
 * "Soda"]] Output:
 ...
 * Constraints:
 * 
 * 1 <= orders.length <= 5 * 10^4 orders[i].length == 3 1 <=
 * customerNamei.length, foodItemi.length <= 20 customerNamei and foodItemi
